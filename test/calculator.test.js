...
describe('calculate()', () => {
  it('should return rounded down numbers for floating decimal results', () => {
    ...
    expect(calculate(542524, propertyTypes.RESIDENTIAL, countries.ENGLAND, buyerTypes.INVESTOR).tax).to.be.equal(18401);
...
describe('calculate()', () => {
  it('should return full object', () => {
    ...
    expect(sdResult.tax).to.be.equal(198750);
    ...
    expect(sdResult.summaryBands[1].taxAdded).to.be.equal(21250);
...
describe('calculate()', () => {
  it('should return correct values for first time buyers', () => {
    ...
    expect(calculate(550000, propertyTypes.RESIDENTIAL, countries.ENGLAND, buyerTypes.FIRST_TIME).tax).to.be.equal(2500);
...
describe('calculate()', () => {
  it('should return correct values for moving home', () => {
    ...
    expect(calculate(350000, propertyTypes.RESIDENTIAL, countries.ENGLAND, buyerTypes.MOVING_HOUSE).tax).to.be.equal(0);
    expect(calculate(550000, propertyTypes.RESIDENTIAL, countries.ENGLAND, buyerTypes.MOVING_HOUSE).tax).to.be.equal(2500);
